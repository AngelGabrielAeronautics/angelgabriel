...
export default function ContactPage() {
  const pageUrl = process.env.SITE_URL + '/contact';
      ...
      <div className="min-h-screen bg-ag-cream">
        ...
        <div className="container mx-auto px-4 py-12 max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="text-2xl font-light font-heading text-text-black mb-6">Contact Information</h2>
              <div className="mb-8">
                ...
                <h3 className="text-lg font-light font-heading text-text-black">Flight Operations & Emergencies:</h3>
