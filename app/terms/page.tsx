      ...
      <div className="container mx-auto px-4 py-12 print:py-2">
        ...
        >
          ...
          <div className="bg-white rounded-lg p-10 mb-10 shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 print:shadow-none print:p-4 print:mb-4">
            <h2 className="text-2xl font-light text-gray-900 mb-6 font-heading">TERMS IN SHORT</h2>
            
            <h3 className="font-light text-xl mb-3 font-heading">BOOKING TERMS:</h3>
            <p>Quotes are valid for 7 days, thereafter a requote may be necessary.</p>
            <p>Invoices are valid for 7 days from issue. Should payment be received outside of this timeframe a rate adjustment may be necessary.</p>
            <p>The quoted aircraft will be held for up to 7 days from quoting. Thereafter should the aircraft be allocated to a different flight; a replacement aircraft cannot be guaranteed.</p>
            
            <h3 className="font-light text-xl mt-6 mb-3 font-heading">ACCEPTANCE:</h3>
            <p>Only on receipt of a signed quotation will a booking be concluded and moved from provisional status to confirmed. An invoice will be issued on receipt of a signed quotation.</p>
            <p>It is important that the agreed expiration timeframes be adhered to:</p>
            ...
            <h3 className="font-light text-xl mt-6 mb-3 font-heading">PAYMENT TERMS:</h3>
            
            <h4 className="font-light mb-2 font-heading">Payment Option 1</h4>
            <p>0% deposit in advance - the booking will remain as provisional until a deposit is received. A requote will be necessary. Aircraft availability cannot be guaranteed.</p>
            
            <h4 className="font-light mt-4 mb-2 font-heading">Payment Option 2</h4>
            <p>50% deposit in advance with the balance no later than 7 days prior to the flight secures the aircraft but does not fix the quoted rate. A requote at the time of the flight may be necessary with the balance payable. Aircraft availability is guaranteed.</p>
            
            <h4 className="font-light mt-4 mb-2 font-heading">Payment Option 3</h4>
            <p>100% payment in advance secures the aircraft and protects the the invoiced rate from the current global fuel fluctuations by up to 15%. Aircraft availability is guaranteed.</p>
            
            <p className="mt-4 font-medium">Strictly no flights will be operated on credit and without the full amount having reflected prior to the flight.</p>
            
            <h3 className="font-light text-xl mt-6 mb-3 font-heading">CANCELLATION TERMS:</h3>
            <ul className="list-disc pl-6 mb-4">
          ...
          <div className="bg-white rounded-lg p-8 mb-10 shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 print:shadow-none print:p-4 print:mb-4">
            <h2 className="text-3xl font-light text-center mb-6 font-heading">ANGEL GABRIEL AERONAUTICS<br />TERMS AND CONDITIONS</h2>
            
            <p className="font-medium">ACCEPTANCE:</p>
            <p>By being in possession of an Angel Gabriel e-ticket you accept the terms and conditions herein. Any willingness to reject the outlined terms and conditions must be brought to Angel Gabriel Aeronautics attention in writing no later than 72 hours prior to the flight.</p>
            
            <p className="font-medium mt-6">UNDERSTANDING:</p>
            <p>Angel Gabriel flights are charter flights, brokered by Angel Gabriel Aeronautics and are NOT scheduled flights.</p>
            
            <p className="font-medium mt-6">AIR TAXIS:</p>
            <p>Air Taxis are not scheduled services; therefore, times and routes may vary, and are dependant on the flight planning of each individual flight. Angel Gabriel will inform the lodge of your expected arrival/departure time.</p>
            
            <p className="font-medium mt-6">AIR TAXI BOOKING WINDOW:</p>
            <p>Bookings on taxi routes closes 72 hours prior to the flight. Any booking made within 72 hours of the flight will be dealt with on an ad hoc basis, and will be subject to aircraft, as well as crew availability. A charter option may be necessary should an appropriate taxi aircraft not be available.</p>
            
            <p className="font-medium mt-6">CHARTER FLIGHT BOOKING WINDOW:</p>
            <p>There is no minimum booking window period for a charter, however, all charters will be subject to aircraft as well as crew availability.</p>
            
            <p className="font-medium mt-6">CREDIT:</p>
            <p>Under no circumstances will any flight be operated on credit, or on part payment. Angel Gabriel has a strict 'No pay, no fly' Policy.</p>
            
            <p className="font-medium mt-6">AIR TAXI PAYMENTS:</p>
            <p>Full payment is required no later than 14 days prior to the flight. Under no circumstances will e-tickets be issued without payment in full. Bookings will be automatically cancelled 7 days prior to the flight, should full payment have not reflected by this time. Any bookings made within 14 days of the flight will require full payment at time of booking.</p>
            
            <p className="font-medium mt-6">CHARTER PAYMENTS:</p>
            <p>All charters strictly require a 50% deposit at the time of acceptance to secure the aircraft. The balance being due no later than 14 days prior to the flight. Full payment is due on receipt of invoice - unless alternate written arrangements have been agreed to. Bookings will be automatically cancelled 7 days prior to the flight, should full payment have not reflected by this time. Any bookings made within 14 days of the flight will require full payment at time of booking.</p>
            
            <p className="font-medium mt-6">CURRENCIES:</p>
            <p>Invoices raised in USD display an exact ZAR amount automatically generated at the time of invoice. The ZAR, as well as the exchange used will appear on the USD invoice. Payments in either USD or ZAR (as per the amount reflected on the invoice) will be accepted.</p>
            
            <p className="font-medium mt-6">CANCELLATION POLICY:</p>
            <p>30% cancellation fee if cancelled (30-15) days prior to the flight</p>
            <p>50% cancellation fee if cancelled (14 days – 73hrs) prior to the flight</p>
            <p>100% cancellation fee if cancelled less than (72hrs) prior to the flight</p>
            
            <p className="font-medium mt-6">REFUNDS:</p>
            <p>Any refunds issued by Angel Gabriel will only be actioned no sooner than 14 working days after the funds have reflected in our account. Foreign currency refunds can only be actioned once all the necessary recipient information has been received. This is a condition set out by the South African Reserve Bank.</p>
            
            <p className="font-medium mt-6">FLIGHT DATE AMENDMENTS:</p>
            <p>Any amendments to a flight date, and or passenger quantity, and or cargo requirement, as previously confirmed - are strictly subject to aircraft availability, crew availability, where necessary over border flight clearance, and border post times of operation. For charters a re-quote may be necessary. In the unfortunate event that the requested amendments cannot be accommodated, for whatever reason, and the client opts not to travel and /or opts to decline a re-quote - then the original flight will be considered to be cancelled - standard cancellation fees will then apply.</p>
            
            <p className="font-medium mt-6">REQUIRED PERSONAL INFORMATION:</p>
            <p>Passengers full names, (as per passport), passport number (for over border flights), as well as gender (for weight and balance calculations) must be supplied for issuing of e-tickets. Angel Gabriel will not be responsible for failing to adequately communicate with passengers should we not receive sufficient and valid contact information.</p>
            
            <p className="font-medium mt-6">BOARDING:</p>
            <p>No passenger shall be permitted to board an aircraft, who is not in possession of a valid e-ticket. Proof of identity may be required at check in.</p>
            
            <p className="font-medium mt-6">PERSONAL WEIGHTS:</p>
            <p>Our aircraft are extremely weight sensitive. We make use of Civil Aviation standards in calculating passenger weights. Male = 104Kg [229lb] Female = 86Kg [190lb]. It is for this reason that persons weighing more than 160kg [353lb] must inform reservations of their weight, at time of booking, allowing for sufficient time for planning.</p>
            
            <p className="font-medium mt-6">CHILDREN:</p>
